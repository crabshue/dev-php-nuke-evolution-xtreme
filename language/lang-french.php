...
define('_MUSTJOIN','Vous devez rejoindre le ');
define('_CREDENTIALS','Vous n''avez pas les droits nécessaires pour<br />accéder ');
define('_AREA','Area!');
# Modules group mod v1.0 END

define('_EMPTY_MESSAGE','Vous devez siasir un message d''abord');
define('_YOUHAVE_1_MSGS','Vous avez <strong><span class="blink-one">%s</span></strong> nouveau message privé');
define('_YOUHAVE_X_MSGS','Vous avez <strong><span class="blink-one">%s</span></strong> nouveaux messages privés');
define('_YOUHAVE_NO_MSGS','Vous avez <strong><span class="blink-one">0</span></strong> NOUVEAU Message. Personne ne vous aime!');

// new common language defines.
define('_S_ADMIN_PANEL','Panneau Admin');
define('_L_ADMIN_PANEL','Administration');
define('_EDIT_PROFILE','Editer Profil');
define('_YOUHAVE_X_MSGS','Vous avez <strong><span class="blink-one">%s</span></strong> nouveaux messages privés');
define('_WATCH_YOUTUBE','Regarde cette vidéo sur Youtube');
define("_POSTEDBY","Envoyé par");
define("_ON","on");
...
define('_NONE', 'Aucun');
define('_PAGEGENERATION', 'Page générée:');
define('_SECONDS', 'Secondes');
define('_LOGOUT', 'Deconnxion');
define('_HTTPREFERERS', 'Références HTTP');
...
define('_HOMEPROBLEM', 'Il y a un gros problème ici : nous n''avons de page d''accueil');
define('_ADDAHOME', 'Ajouter un module dans l''accueil');
define('_HOMEPROBLEMUSER', 'Nous avons un problème sur la page d''acceuil. Merci de véfifier plus tard');
